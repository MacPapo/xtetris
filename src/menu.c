...
int menu()
{
    ...
    modCounter = user_choice = 0; /**< Inizializzo modCounter && userChoice */
    ...
    wbkgd(s_desc, COLOR_PAIR(3)); /**< Coloro la window selezionata con la seguente palette */
    ...
    do /**< Inizia la sequenza di istruzioni da eseguire */
    {
        ...
        user_choice = wgetch(s_menu); /**< Prendo l'input da tastiera da parte dell'utente */
        switch (user_choice)  /**< Casistica della scelta dell'utente */
        {
            case KEY_UP:
