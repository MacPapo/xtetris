...
/* void initField(WINDOW *title, WINDOW *field, WINDOW *preview, WINDOW *score, */
/*                WINDOW *save, WINDOW *cmds); */
...
/* void refreshGameField(int *x, tet *current_piece, int gamefield[][MATRIX_W], */
/*                       WINDOW *win); */
/* void refreshScore(WINDOW *s_score, int pieces, int *score); */
/* void printMatrix(int gamefield[][MATRIX_W]); */

/* void playerChoices(player *player, tet *current_piece, int *pieces, */
/*                    int gamefield[][MATRIX_W]); */
...
/* int previewGamefield[MATRIX_H_PREV][MATRIX_W]; */
...
/*   WINDOW *w_title = NULL, *w_field = NULL, *w_preview = NULL, *w_score = NULL, */
/*          *w_save = NULL, *w_cmds = NULL; */
...
/*   /\* initialize the game matrix & init the base screen & creating the */
/*    * refreshable windows *\/ */
...
/*     for (col = 0; col < MATRIX_W; col++) { */
/*       if (previewGamefield[row][col] != 0) { */
/*         gamefield[row + counter][col] = previewGamefield[row][col]; */
/*       } */
/*     } */
/*   } */
